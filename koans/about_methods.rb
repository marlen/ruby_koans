...
class AboutMethods < EdgeCase::Koan
  ...
  def test_sometimes_missing_parentheses_are_ambiguous
    ...
    var_my_global_method = my_global_method 2,3
    var_assert_equal = assert_equal 5, var_my_global_method 
    eval "var_assert_equal" 
    eval "assert_equal 5, var_my_global_method" # ENABLE CHECK
  end
    #
  ...
  def test_calling_private_methods_with_an_explicit_receiver
    ...
    assert_match /private method `my_private_method' called for #<AboutMethods:0x00000*/, exception.message
  end
